...
export type AllEpisodesQuery = {
  __typename?: 'Query';
  episodes: {
    __typename?: 'Episodes';
    info: { __typename?: 'Info'; count: number | null; pages: number | null; next: number | null } | null;
    results: Array<{
      __typename?: 'Episode';
      id: string | null;
      name: string | null;
      episode: string | null;
      characters: Array<{ __typename?: 'Character'; id: string | null; name: string | null } | null>;
    } | null> | null;
  } | null;
};
...
} as unknown as DocumentNode<AllEpisodesQuery, AllEpisodesQueryVariables>;
